...
class _Entity(_Call):
    ...
    def _common(self):
        ...
        if parent.lineType != None:
            result += "\n6\n%s" % parent.lineType
        if parent.lineWeight != None:
            result += "\n370\n%s" % parent.lineWeight
        if parent.lineTypeScale != None:
            result += "\n48\n%s" % parent.lineTypeScale
        if parent.thickness != None:
            result += "\n39\n%s" % parent.thickness
        return result
...
class Arc(_Entity):
    ...
    def __init__(
        self, center=(0, 0, 0), radius=1, startAngle=0.0, endAngle=90, **common
    ):
        """Angles in degrees."""
...
class LineType(_Call):
    ...
    def __init__(
        self, name="continuous", description="Solid line", elements=[], flag=64
    ):
...
class Rectangle(_Entity):
    ...
    def __init__(
        self, point=(0, 0, 0), width=1, height=1, solid=None, line=1, **common
    ):
        _Entity.__init__(self, **common)
        self.point = point
        self.width = width
...
def main():
    ...
    d.append(
        Rectangle(point=(2, 2, 2), width=4, height=3, color=6, solid=Solid(color=2))
    )
    d.append(Solid(points=[(4, 4, 0), (5, 4, 0), (7, 8, 0), (9, 9, 0)], color=3))
    d.append(
        PolyLine(points=[(1, 1, 1), (2, 1, 1), (2, 2, 1), (1, 2, 1)], closed=1, color=1)
    )
