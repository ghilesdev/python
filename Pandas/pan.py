...
# df_new_new.to_csv('formatted_data.csv', date_format='%B %d, %Y')
# df['IND_DAY']=pd.to_datetime(df['IND_DAY'])
# df.to_json('formated_date.json')
# df.to_json('new-data-time.json', date_format='iso', date_unit='s')

# df_new=pd.read_csv('new_data.csv', index_col=0)
dtypes = {'POP': 'float64', 'AREA': 'float64', 'GDP': 'float64',
          'IND_DAY': 'datetime64'}
# df_new_new=pd.read_csv('data.csv', index_col=0, dtype=dtypes, parse_dates=['IND_DAY'])
